...
runTest("Get highFlyers to return all known flyers", function () {
  const heroes = [{name: "Spiderman", ability: "spidey-sense", isAnonymous: true},
  ...
  check(highFlyers(heroes)).isEqualTo([{name: "Ironman", ability: "flying", isAnonymous: false},{name: "Wonderwoman", ability: "flying", isAnonymous: false}]);
});
